  ...
  <div class="app-container">
    <el-form ref="channelForm" :rules="rules" :model="channel" label-width="120px">
      <el-form-item label="菜单名称" prop="name">
        <el-input maxlength="20" show-word-limit v-model="channel.name" placeholder="请输入菜单名称" />
      </el-form-item>

      <el-form-item label="菜单标志" prop="icon">
        <el-input maxlength="100" show-word-limit v-model="channel.icon" placeholder="请输入图标代码" />
      </el-form-item>

      <el-form-item label="权重" prop="weight">
        <el-input v-model="channel.weight" placeholder="请输入权重编号，默认：1" />
      </el-form-item>
